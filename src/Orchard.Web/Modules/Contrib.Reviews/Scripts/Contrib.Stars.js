            ...
            return $(this).each(function () {
                ...
                _this
                    .click(function () {
                        ...
                        var ratingDropDownList = form.find('[name="rating"]');
                        ratingDropDownList.children("option").attr("selected", false).end();
                        ratingDropDownList.children('option[value="' + rating + '"]').attr("selected", "selected");

                        var data = form.serialize();
                        data = data.replace("rating=0", "rating=" + rating);
                        $.post(
                            form.attr("action"),
                            data
                        );
